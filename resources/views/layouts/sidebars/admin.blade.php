...
<x-sidebar-link href="{{ route('admin.bookings.index') }}" :active="request()->routeIs('admin.bookings.*')">
    ...
    {{ __('dashboard.sidebar.bookings_admin') }}
</x-sidebar-link>
...
<x-sidebar-link href="{{ route('notifications.index') }}" :active="request()->routeIs('notifications.*')">
    ...
    {{ __('dashboard.sidebar.notifications') }}
    @if($adminUnreadNotifications > 0)
        <span class="dash-nav-badge">{{ $adminUnreadNotifications }}</span>
    @endif
</x-sidebar-link>
...
<x-sidebar-link href="{{ route('admin.documents.index') }}" :active="request()->routeIs('admin.documents.*')">
    ...
    {{ __('dashboard.sidebar.documents') }}

...
@section('content')
    ...
    <div class="flex flex-wrap justify-between items-center gap-3 mb-6">
        ...
        <div class="flex items-center gap-2">
            <a href="{{ route('vendor.bookings.export', request()->only(['status', 'sort_by', 'sort_dir'])) }}"
    ...
    <div class="mb-6 bg-white border border-gray-200 rounded-lg p-4">
        <form action="{{ route('vendor.bookings.index') }}" method="GET" class="flex flex-wrap items-end gap-3">
            <div>

...
@section('content')
    <div class="max-w-2xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            @if($booking->payment)
                @php
                    $proofStatus = $booking->payment->proof_status ?? 'not_uploaded';
                    ...
                    $proofReviewerLabel = match ($booking->payment->proof_reviewer_role) {
                        'admin' => 'Admin',
                        'vendor' => 'Vendor',
                        default => '-',
                    };
                    ...
                    <div class="space-y-2">
                        ...
                        @if($booking->payment->proof_status === 'uploaded')
                            <div class="border-t pt-3 mt-3 space-y-3">
                                ...
                                <form action="{{ route('vendor.bookings.paymentProof.approve', $booking) }}" method="POST" class="space-y-2">
                                    @csrf
                                ...
                                <form action="{{ route('vendor.bookings.paymentProof.reject', $booking) }}" method="POST" class="space-y-2"
